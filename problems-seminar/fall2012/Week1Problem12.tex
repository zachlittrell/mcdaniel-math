...
\begin{enumerate}
  \item Given three snooze vertices, $v$,$w$, and $x$,\\
        ...
        But, since $\neg(v \circledast (x \oslash w))$, then
...
By Lemma 1, $L \circledast (M \oslash N)$.
...
\begin{enumerate}
  ...
  \item Without loss of generality, let $X = N$.\\
        ...
        So, there is some span of time where $Y \oslash Z$ with
